#!/usr/bin/env python
"""Run Atari Environment with linear double-DQN."""
import argparse
import os
import random
import time
...
def main():  # noqa: D103
    ...
    parser.add_argument(
        '-o', '--output', default='linear-double-deepQ', help='Directory to save data to')
    ...
    q_net = create_model(4, (84, 84), num_actions, model_name='Linear-Double_Deep_Q_Net')
